...
@rem  本文件以上内容源自于Visual Studio 2010中的同名文件。
@rem  以下内容是书籍《Qt中的C++技术》的作者张波添加的。
@rem  我们将Qt 4.8.1的可执行文件（比如qmake, moc等）的路径添加到环境变量PATH中
@set PATH=D:\QtSDK\Desktop\Qt\4.8.1\msvc2010\bin;%PATH%

@rem 将perl的可执行路径添加到PATH中
@set PATH=d:\perl\bin;%PATH%

@set QTDIR=D:\QtSDK\Desktop\Qt\4.8.1\msvc2010
